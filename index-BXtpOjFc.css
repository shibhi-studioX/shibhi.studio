...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    ...
    --secondary: oklch(92% 0.02 240);
    --secondary-foreground: oklch(15% 0.02 240);
    --muted: oklch(92% 0.02 240);
    --muted-foreground: oklch(50% 0.02 240);
    --accent: oklch(92% 0.02 240);
    --accent-foreground: oklch(15% 0.02 240);
    --destructive: oklch(55% 0.22 25);
    --destructive-foreground: oklch(98% 0.01 240);
    --border: oklch(85% 0.02 240);
    --input: oklch(85% 0.02 240);
    --ring: oklch(45% 0.15 240);
    --radius: 0.5rem;
    --chart-1: oklch(60% 0.15 10);
    --chart-2: oklch(65% 0.15 150);
    --chart-3: oklch(55% 0.15 30);
    --chart-4: oklch(70% 0.12 270);
    --chart-5: oklch(62% 0.18 340);
  }
  ...
  .dark {
    ...
    --card-foreground: oklch(98% 0.01 240);
    --popover: oklch(18% 0.02 240);
    --popover-foreground: oklch(98% 0.01 240);
    --primary: oklch(70% 0.15 240);
    --primary-foreground: oklch(15% 0.02 240);
    --secondary: oklch(25% 0.02 240);
    --secondary-foreground: oklch(98% 0.01 240);
    --muted: oklch(25% 0.02 240);
    --muted-foreground: oklch(65% 0.02 240);
    --accent: oklch(25% 0.02 240);
    --accent-foreground: oklch(98% 0.01 240);
    --destructive: oklch(55% 0.22 25);
    --destructive-foreground: oklch(98% 0.01 240);
    --border: oklch(25% 0.02 240);
    --input: oklch(25% 0.02 240);
    --ring: oklch(70% 0.15 240);
    --chart-1: oklch(65% 0.18 15);
    --chart-2: oklch(70% 0.15 155);
    --chart-3: oklch(60% 0.18 35);
    --chart-4: oklch(75% 0.12 275);
    --chart-5: oklch(68% 0.20 345);
  }
  * {
...
/* Category hover effect with slimmer contained glow, longer transitions, and animated outline */
...
.category-hover-effect:focus::before {
  opacity: 1;
}

.category-hover-effect:hover::after,
.category-hover-effect:focus::after {
  opacity: 1;
  animation: outline-trace 1.2s ease-in-out;
}
...
/* Smooth scrolling for sub category boxes */
html {
  scroll-behavior: smooth;
}

/* Sub category box scrolling - mobile and desktop */
.overflow-y-auto,
.overflow-x-auto,
.overflow-auto {
  scroll-behavior: smooth;
...
/* Glass panel overlay responsive sizing */
.glass-panel {
  max-height: 90vh;
}
...
/* Ensure flex layout for scrollable content */
...
/* Move vinyl player to the left near header */
@media (min-width: 1024px) {
  /* Vinyl player positioning - place it right after the header text */
  .lg\:ml-8 {
    margin-left: 2rem;
  }
  
  /* Move HDD setup closer to categories */
  .lg\:-ml-48 {
